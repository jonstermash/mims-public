...
Then invoke a skill by name — `/make-it-make-sense`, `/syco-killer`, or `/mims-strategy-planner`. New skills added to the repo arrive automatically when you sync the marketplace.
...
| Skills | `/make-it-make-sense`, `/syco-killer`, `/mims-strategy-planner` |
...
| [mims-strategy-planner](./plugins/make-it-make-sense/skills/mims-strategy-planner/) | Turn scattered research and notes into a strategy that guides decisions. Five stages — Goal, Objectives, Audiences, Messaging, Tactics — locked in order, with a protocol for reopening one when the evidence changes. |

### Turning on syco-killer

All three skills work as soon as they're installed — type `/make-it-make-sense`, `/syco-killer`, or `/mims-strategy-planner`.
